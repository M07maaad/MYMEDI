...
setDrugs(p => p.filter((*, i) => i !== idx))
setSchedules(p => p.filter((*, i) => i !== idx))
...
If only one medication, still return an array with one item.`}, { type: 'image_url', image_url: { url:`data:${file.type};base64,${base64}` } }
]
}],
max_tokens: 800,
}),
